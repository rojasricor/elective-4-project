      ...
      <main className='px-40 py-20'>
        <section className='flex justify-center items-center gap-16'>
          ...
          <div className='flex flex-col gap-3 w-5/12'>
            <h1 className='font-bold text-4xl text-[#79ad34]'>¿Quienes somos?</h1>
            <p className='text-gray-600 text-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea delectus provident necessitatibus laudantium in officia soluta vitae quasi autem consequatur dolor omnis ratione incidunt voluptatum illum temporibus nostrum similique saepe consequuntur, aspernatur esse commodi inventore. Quisquam, quibusdam. Laboriosam, maiores labore?</p>
        ...
        <div className="bg-white py-24 sm:py-32">
          <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
            <div className="max-w-2xl">
              <h2 className="text-3xl font-bold tracking-tight text-[#79ad34] sm:text-4xl">Nuestro Equipo</h2>
              <p className="mt-6 text-lg leading-8 text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum magni incidunt voluptate dicta possimus veritatis voluptatem, illo magnam quis quo?</p>
            </div>
            <ul role="list" className="grid gap-x-8 gap-y-12 sm:grid-cols-2 sm:gap-y-16 xl:col-span-2">
              <li>
                <div className="flex items-center gap-x-6">
                  ...
                  <div>
                    <h3 className="text-base font-semibold leading-7 tracking-tight text-gray-900">Lorem, ipsum.</h3>
                    <p className="text-sm font-semibold leading-6 text-[#008aae]">Lorem, ipsum.</p>
                  </div>
                </div>
              </li>
              <li>
