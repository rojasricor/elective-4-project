...
function Contact(): React.ReactNode {
  ...
  const jeankis = faJenkins
  const Registrer = faUniregistry
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-6 mr-2 bg-gray-100 dark:bg-gray-200 sm:rounded-lg">
                ...
                <div className="flex items-center mt-8 text-gray-800 dark:text-gray-700">
                  <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" className="w-8 h-8 text-blue-800">
                ...
                <div className="flex items-center mt-4 text-gray-600 dark:text-gray-700">
                  <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" className="w-8 h-8 text-green-700">
                ...
                <div className="flex items-center mt-2 text-gray-600 dark:text-gray-700">
                  <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" className="w-8 h-8 text-red-500">
              ...
              <form className="p-6 flex flex-col justify-center mt-0">
                <div className="flex flex-col mt-2 relative">
                  ...
                  <input type="name" name="name" id="name" placeholder="Full Name" className="w-100 mt-2 py-3 px-3 pl-12 rounded-lg bg-white dark:bg-gray-200 border border-gray-400 dark:border-gray-700 text-gray-400 font-semibold focus:border-indigo-500 focus:outline-none" />
                </div>
                ...
                <div className="flex flex-col mt-2 relative">
                  ...
                  <input type="email" name="email" id="email" placeholder="Email" className="w-100 mt-2 py-3 px-3 pl-12 rounded-lg bg-white dark:bg-gray-200 border border-gray-400 dark:border-gray-700 text-gray-400 font-semibold focus:border-indigo-500 focus:outline-none" />
                </div>
                ...
                <div className="flex flex-col mt-2 relative">
                  ...
                  <input type="tel" name="tel" id="tel" placeholder="Telephone Number" className="w-100 mt-2 py-3 px-3 pl-12 rounded-lg bg-white dark:bg-gray-200 border border-gray-400 dark:border-gray-700 text-gray-400 font-semibold focus:border-indigo-500 focus:outline-none" />
                </div>

                <div className="flex flex-col mt-2 relative">
                  <label htmlFor="message" className="hidden">Asunto</label>
                  ...
                  <textarea name="message" id="message" placeholder="Asunto" className="w-100 h-20 mt-2 py-3 px-3 pl-12 rounded-lg bg-white dark:bg-gray-300 border border-gray-400 dark:border-gray-700 text-gray-600 font-semibold focus:border-indigo-700 focus:outline-none" />
                </div>
